...
BLASTDIR=/home/mmbrand/annotate/blastDB/
SCRIPTSDIR=/home/mmbrand/annotate/Runscripts/
...
wget ftp://ftp.sanger.ac.uk/pub/MEROPS/current_release/pepunit.lib &
...
mv pepunit.lib  ${BLASTDIR}/compressed/
