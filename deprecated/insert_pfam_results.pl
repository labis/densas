...
print "Table ok! Continuing PFAM\n";
#}
...
$dbh->do("INSERT INTO  $PRJ\_PFAM (seqname, pfamA_id, pfamA_acc, Best_domain, Full_sequence) VALUES ('$seqname', '$pfamA_id', '$pfamA_acc', '$Best_domain', '$Full_sequence')");
  $dbh->commit();
